...
<link rel="stylesheet" href="popup_style.css">
  <!--  Project Developed by: Prasanna balaji KK. 
 for any PHP, Codeignitor or Laravel work contact me through www.Prasanna balaji Kk.com  --> 
...
<?php
 ...
 background-color: #cccccc;background-repeat: no-repeat;background-size: 1400px 900px;">
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class=" card">
                            <center><img src="./assets/uploadImage/Logo/<?php echo $row_login['login_logo'];?>" style="height:200px;width:200px;"></center><br><!-- <h4>Login</h4> -->
                            <div class="login-form">
                                
                                <form method="POST">
  <!--  Project Developed by: Prasanna balaji K. 
 for any PHP, Codeignitor or Laravel work contact me through nobelsoftware.in  --> 
                                  ...
                                  <div class="register-link m-t-15 text-center">
                                        <p>Developed by <a href="#"> Nobel Software Solutions !</a></p>
                                    </div> 
                                </form>
                            </div>
                        </div>
